...
SYMBOL = os.getenv("SIGNAL_SYMBOL", _cfg.get("SYMBOL", "SOLUSDT"))
INTERVAL = os.getenv("SIGNAL_INTERVAL", _cfg.get("INTERVAL", "60"))
EQUITY = float(os.getenv("SIGNAL_EQUITY", _cfg.get("EQUITY", "200")))
LEVERAGE = int(os.getenv("SIGNAL_LEVERAGE", _cfg.get("LEVERAGE", "5")))
RISK_FRAC = float(os.getenv("SIGNAL_RISK_FRAC", _cfg.get("RISK_FRAC", "0.02")))
MAINT_RATE = float(os.getenv("SIGNAL_MAINT_RATE", _cfg.get("MAINT_RATE", "0.004")))
TRADING_START = int(os.getenv("SIGNAL_TRADING_START", _cfg.get("TRADING_START", "7")))
TRADING_END = int(os.getenv("SIGNAL_TRADING_END", _cfg.get("TRADING_END", "19")))
